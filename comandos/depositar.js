...
module.exports.run = async (bot, message, args, database) => {
    ...
    if(quantidade > coins){
        return message.channel.send(`<:erro:664956331643371532> Você não contém esse número de coins para depositar.`)
    } else {
...
message.channel.send(`🏦 Você depositou **__${quantidade} coins__** do seu banco!`)
